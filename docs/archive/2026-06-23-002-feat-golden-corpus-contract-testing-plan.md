...
related: [SYMPH-914, SYMPH-999, SYMPH-908, SYMPH-909, SYMPH-913, MOB-348, SYMPH-774]
---

# feat: Automated golden-corpus contract testing (crucible/crabrunner ↔ Symphony)

> **Archived 2026-07-09 by SYMPH-1071.** This cross-repo plan mixed corpus
> ownership, producer conformance, consumer conformance, CI enforcement, and
> drift monitoring. The accepted re-scope makes Crucible the corpus owner,
> keeps producer conformance with the producer, and starts the live drift
> detector report-only. SYMPH-914 owns that workstream and SYMPH-999 owns the
> first consumer-corpus slice. The W1 execution-seam fixtures added by
> SYMPH-1071 are deliberately narrow and do not build this corpus.
