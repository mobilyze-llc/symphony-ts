...
The canonical retrospective replay corpus intentionally requires at least 10
cases. The validator rejects corpora with 9 or fewer replay cases instead of
preserving the older loose "roughly 10" compatibility window.
...
Remediate by adding source-backed replay cases until the corpus reaches 10
cases; do not pad with invented cases or runtime/model-call data.
